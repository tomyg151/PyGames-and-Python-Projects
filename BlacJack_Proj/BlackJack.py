...
#function compare(), pass in the user_score and computer_score.
...
def compare(user_score, computer_score):
  """compare the user score vs the computer score to see who win's"""
...
def play_game():
  ...
  while not is_game_over:
    ...
    if user_score == 0 or computer_score == 0 or user_score > 21:
      ...
      If yes, then use the deal_card() function to add 
